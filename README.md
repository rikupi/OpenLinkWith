...
- **Open Link With** — [Said Tahsin Dane](https://github.com/nicktasomaniac) (tasomaniac) 作、[Sam Leatherdale](https://github.com/SamLeatherdale) によるメンテナンス — Apache License 2.0
...
- **Open Link With** by [Said Tahsin Dane](https://github.com/nicktasomaniac) (tasomaniac), maintained by [Sam Leatherdale](https://github.com/SamLeatherdale) — Apache License 2.0
- **OneUI Design Library** by [Tribalfs](https://github.com/tribalfs/oneui-design), Yanndroid & BlackMesa123 — MIT License
- **SESL** (Samsung Experience Support Library) by [Tribalfs](https://github.com/tribalfs/sesl-androidx) — Apache License 2.0
